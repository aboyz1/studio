...
import { Users, Gem, Settings, HelpCircle } from 'lucide-react';
  ...
  return (
    <Tabs defaultValue="characters" className="h-full flex flex-col">
      <TabsList className="grid w-full grid-cols-4 bg-card/70 backdrop-blur-sm">
        ...
        <TabsTrigger value="help" className="font-headline"><HelpCircle className="mr-2 h-4 w-4" />Help</TabsTrigger>
      ...
      <TabsContent value="characters" className="flex-1 -mt-1">
       ...
       <TabsContent value="help" className="flex-1 -mt-1">
        <HelpPanel />
      </TabsContent>
